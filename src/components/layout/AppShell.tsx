...
export function AppShell({ children }: AppShellProps) {
  ...
  const { orchestrationPhase, pendingQuestion, activePlan } = useTaskStore(
    useShallow((s) => ({ orchestrationPhase: s.orchestrationPhase, pendingQuestion: s.pendingQuestion, activePlan: s.activePlan })),
  );
