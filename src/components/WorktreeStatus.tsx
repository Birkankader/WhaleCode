...
export function WorktreeStatus({ projectDir }: { projectDir: string }) {
  ...
  return (
    <Card className="rounded-lg border-zinc-800 bg-zinc-900/50 py-0 gap-0">
      {/* Header */}
      <CardHeader className="flex-row items-center justify-between px-4 py-3 border-b border-zinc-800 gap-0">
        <div className="flex items-center gap-2">
          <CardTitle className="text-sm">Active Worktrees</CardTitle>
              ...
              <div key={wt} className="flex items-center justify-between px-4 py-2.5">
                ...
                <div className="flex items-center gap-2 shrink-0 ml-3">
                  ...
                  <Button
                    ...
                    className="bg-blue-600/20 text-blue-400 hover:bg-blue-600/30 border-blue-600/30"
                    title={
                      hasConflicts
