...
describe('humanizeError', () => {
  ...
  it('maps "not valid JSON" to decomposition-friendly message', () => {
    expect(humanizeError('Response is not valid JSON: unexpected token')).toContain('unexpected response format');
  });
