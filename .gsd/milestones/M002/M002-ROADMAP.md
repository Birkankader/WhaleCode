...
- [ ] **S01: Decomposition & Error Pipeline** `risk:high` `depends:[]`
...
- [ ] **S02: Worktree Isolation & Parallel Workers** `risk:high` `depends:[S01]`
...
- [ ] **S03: Frontend State & Approval Flow** `risk:medium` `depends:[S01]`
...
- [ ] **S04: Review, Merge & Cleanup** `risk:medium` `depends:[S02,S03]`
...
- [ ] **S05: UI Cleanup & Anti-Pattern Removal** `risk:low` `depends:[S03]`
...
- [ ] **S06: End-to-End Integration Verification** `risk:low` `depends:[S04,S05]`
